...
import com.submission.githubuserapi.ui.MainActivity
import com.submission.githubuserapi.utils.isDateInvalid
import java.util.*
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    private fun showAlarmNotification(
        ...
        val builder = NotificationCompat.Builder(context, channelId)
            ...
            .setContentTitle(context.getString(R.string.title_hello))
            .setAutoCancel(true)
    ...
    fun setRepeatingAlarm(context: Context, type: String, time: String, message: String) {
        ...
        Log.d("TAG", TIME_FORMAT.isDateInvalid(time).toString())
        ...
        Toast.makeText(context, "Pengingat Sudah Dibuat", Toast.LENGTH_SHORT).show()
    }
